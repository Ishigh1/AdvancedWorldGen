...
namespace AdvancedWorldGen.BetterVanillaWorldGen
{
	public class RandomGems : ControlledWorldGenPass
	{
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
		{
			...
			{
				int num162 = Random.Next(20, Main.maxTilesX - 20);
				int num163 = Random.Next((int) Main.rockLayer, yMax);
			...
			{
				int num167 = Random.Next(20, Main.maxTilesX - 20);
				int num168 = Random.Next((int) Main.worldSurface, yMax);
